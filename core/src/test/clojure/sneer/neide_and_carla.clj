...
(defn neide-and-carla []
  (let [neide (sneer!)
        ...
        _  (<next (. n-convos startConvo "Id displacer 1"))
        _  (<next (. n-convos startConvo "Id displacer 2"))
        _  (<next (. n-convos startConvo "Id displacer 3"))
        _  (<next (. n-convos startConvo "Id displacer 4"))
        _  (<next (. n-convos startConvo "Id displacer 5"))
