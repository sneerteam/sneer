...
public class Convo {
    ...
    public Convo(long id, String nickname, String inviteCodePending, Chat chat, List<SessionSummary> sessionSummaries) { this.id = id; this.nickname = nickname; this.inviteCodePending = inviteCodePending; this.chat = chat; this.sessionSummaries = sessionSummaries; }
