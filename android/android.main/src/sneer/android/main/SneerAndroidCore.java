...
public class SneerAndroidCore implements SneerAndroid {
	...
	public static final class PartnerSession implements SharedResultReceiver.Callback {
		...
		private PartnerSession(SneerPluginInfo app, PublicKey host, PublicKey partner, long sessionId, ClassLoader classLoader, Sneer sneer) {
			this.host = host;
